...
void main() {
  group('HazardVote AI field deserialization & access', () {
    ...
    test(
      'Step 11: deserializes synthetic image risk fields (LOW, UNCERTAIN, ELEVATED)',
      () {
        for (final risk in [
          ...
          expect(
            vote.aiAnalysis.syntheticImageSummary,
            'Assessment summary for $risk',
          );
        }
      },
    );
    ...
    test(
      'Step 11: truncates synthetic summary to 200 chars and trims whitespace',
      () {
    ...
    test(
      'Step 11: invalid synthetic risk enum degrades to null without crashing',
      () {
    ...
    test(
      'Step 11: synthetic risk does not alter AI multiplier calculation',
      () {
