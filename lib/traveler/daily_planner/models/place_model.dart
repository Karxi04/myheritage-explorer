...
class PlaceModel {
  ...
  PlaceModel copyWith({
    ...
    String? trustLabel,
    String? vendorId,
    String? culturalTaskId,
    Map<String, dynamic>? culturalTask,
    String? phone,
    String? website,
    String? mealRole,
  }) {
    return PlaceModel(
      ...
      validReviewCount: validReviewCount ?? this.validReviewCount,
      ...
      culturalTaskId: culturalTaskId ?? this.culturalTaskId,
      culturalTask: culturalTask ?? this.culturalTask,
      phone: phone ?? this.phone,
      website: website ?? this.website,
      mealRole: mealRole ?? this.mealRole,
    );
  }
